...
export function DemoDisclaimerBanner() {
  return (
    <div className="mb-6 flex items-start gap-2.5 rounded-[var(--radius-md)] border border-info-100 bg-info-100/60 px-4 py-3 text-sm text-ink-700">
      ...
      <p>
        <span className="font-semibold">Entorno de demostración.</span> Datos, firma y workflow son
        simulados — sin validez legal, sin backend y sin persistencia real. El selector de rol es solo
